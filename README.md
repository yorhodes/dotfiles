...
using [yabai](https://github.com/koekeishiya/yabai) for window management with [simple-bar](https://github.com/Jean-Tinland/simple-bar) as an [Übersicht](https://github.com/felixhageloh/uebersicht) status bar
